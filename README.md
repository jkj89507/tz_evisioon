# tz_evision
Данная работа выполнена в рамках технического задания: https://github.com/eVisionTech/python-homework на должность Python-разработчик

# Сборка
Шаги:
1. Выкачаете проект в нужную для Вас директорию;
2. Перейдите внутрь проекта;
3. Выполните команду docker-compose build (от имени администратора);
4. Выполните команду docker-compose up (от имени администратора);
